  ...
  return (
    <div className='side-nav'>
                          ...
                          if (accordionCategory.id === subCategory.parent_category_id) {
                            return (
                              <li className='sub-items'>
                                <a href='#' onClick={() => filteredData(subCategory)}>{subCategory.category}</a>
                              </li>
                            )
                          }
                        }
      ...
      <div className='price-filter-container'>
        ...
        <button className='btn btn-outline-dark my-3 w-100' onClick={applyPriceFilter}> Apply Filter</button>
      </div>
    </div>
  )
}
